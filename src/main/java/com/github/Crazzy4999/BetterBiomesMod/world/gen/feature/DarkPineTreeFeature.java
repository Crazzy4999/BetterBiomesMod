...
public class DarkPineTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   ...
   public DarkPineTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51429_1_, boolean p_i51429_2_) {
