...
public class BBMBambooFeature extends Feature<ProbabilityConfig> {
   ...
   public BBMBambooFeature(Function<Dynamic<?>, ? extends ProbabilityConfig> p_i49919_1_) {
      super(p_i49919_1_);
   }
               ...
               for(int l = pos.getX() - k; l <= pos.getX() + k; ++l) {
                  for(int i1 = pos.getZ() - k; i1 <= pos.getZ() + k; ++i1) {
                     ...
                     if (j1 * j1 + k1 * k1 <= k * k) {
                        ...
                        if (worldIn.getBlockState(blockpos$mutableblockpos1).getBlock().isIn(BlockTags.BAMBOO_PLANTABLE_ON)) {
