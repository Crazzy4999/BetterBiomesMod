...
public class MegaDarkPineTree extends HugeTreesFeature<NoFeatureConfig> {
   private static final BlockState TRUNK = BetterBiomeBlocks.darkpine_log.getDefaultState();
   private static final BlockState LEAF = BetterBiomeBlocks.darkpine_leaves.getDefaultState();
   private static final BlockState PODZOL = Blocks.PODZOL.getDefaultState();
   private final boolean useBaseHeight;

   public MegaDarkPineTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyOnPlace, boolean useBaseHeightIn) {
      super(configFactoryIn, doBlockNotifyOnPlace, 13, 15, TRUNK, LEAF);
      this.useBaseHeight = useBaseHeightIn;
      setSapling((net.minecraftforge.common.IPlantable)BetterBiomeBlocks.darkpine_sapling);
   }
